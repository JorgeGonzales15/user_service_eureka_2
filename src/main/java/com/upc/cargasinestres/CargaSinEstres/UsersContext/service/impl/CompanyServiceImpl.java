...
public class CompanyServiceImpl implements ICompanyService {
    ...
    public int calculateAverageRating(Long companyId) {
        try {
            String url = "http://localhost:8011/api/v1/ratings/company/" + companyId;
    ...
    public List<Long> getServiceIds() {
        String url = "https://localhost:8011/api/v1/services";
    ...
    public List<String> getNamesOfServicesByIdList(List<Long> serviceIds) {
        String url = "http://localhost:8011/api/v1/services/";
